        ...
        if clientPassword == serverPassword:
            ...
            while 1:
                ...
                # Process client command
                    ...
                    turnServerOff()
                elif wordsInCommand[0].lower() == "test" :
...
if __name__ == "__main__":
    ...
    server = socketserver.ThreadingTCPServer((HOST, PORT), MyTCPHandler)                  # Instantiate the threaded TCP server class and give it our handler
